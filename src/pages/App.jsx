...
const images = ["./pages/images/adidas.avif", "./pages/images/dyson.png"];
...
function App() {
  return (
    <div>
      <div
        className="hero"
        style={{ width: "100%", height: "80vh", backgroundColor: "#F7ECE7" }}
      >
          ...
          <div style={{ width: "80%", margin: "0 auto" }}>
            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
              ...
              <div className="col-lg-6">
                ...
                <p className="lead">
                  Fall has arrived and it's time to get cozy with our cashmere
        ...
        <div className="row g-4 py-3 row-cols-1 row-cols-lg-2">
          ...
          >
            ...
            <p style={{ color: "#737373" }}>
              We ensure our vendors commit to delivering top products
            </p>
          </div>
          <div className="feature col text-center" style={{ padding: "20px" }}>
            ...
            <p style={{ color: "#737373" }}>
              Go through our vetting process and submit your products
            </p>
          </div>
        </div>
      </div>
